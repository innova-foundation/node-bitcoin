module.exports = {
  ...
  fortunaStakeCount: 'fortunastake count',
  fortunaStakeGenKey: 'fortunastake genkey',
  fortunaStakeStatus: 'fortunastake status',
  fortunaStakeList: 'fortunastake list',
  help: 'help',
  ...
  move: 'move',
  masterNode: 'masternode', //Denarius v2.0
  getNewStealthAddress: 'getnewstealthaddress',
  getPoolInfo: 'getpoolinfo',
  getHashesPerSec: 'gethashespersec',
  listStealthAddresses: 'liststealthaddresses',
  sendToStealthAddress: 'sendtostealthaddress',
